...
from viewgen3d.models.nn.camera import DifferentiableCamera, DifferentiableProjectiveCamera
from viewgen3d.models.nn.meta import subdict
from viewgen3d.models.nn.utils import to_torch
from viewgen3d.models.query import Query
from viewgen3d.models.renderer import Renderer, get_camera_from_batch
from viewgen3d.models.volume import BoundingBoxVolume, Volume
from viewgen3d.rendering.blender.constants import BASIC_AMBIENT_COLOR, BASIC_DIFFUSE_COLOR
from viewgen3d.rendering.mc import marching_cubes
from viewgen3d.rendering.torch_mesh import TorchMesh
from viewgen3d.rendering.view_data import ProjectiveCamera
from viewgen3d.util.collections import AttrDict
...
def _render_with_pytorch3d(
    ...
    from viewgen3d.rendering.pytorch3d_util import (
...
def _render_with_raycast(
    ...
    from viewgen3d.rendering.raycast.render import render_diffuse_mesh
    from viewgen3d.rendering.raycast.types import TriMesh as TorchTriMesh
